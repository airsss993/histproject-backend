...
VALUES (1, 'Бородинское сражение',
        ...
        55.5167, 35.8167, '1812-09-07', 1, 'https://example.com/borodino', 'https://example.com/images/borodino.jpg'),
       (1, 'Взятие Бастилии', 'Начало Великой французской революции, штурм крепости-тюрьмы.',
        48.8531, 2.3698, '1789-07-14', 4, 'https://example.com/bastille', 'https://example.com/images/bastille.jpg'),
       (1, 'Потсдамская конференция', 'Встреча лидеров трех держав для определения послевоенного устройства Европы.',
        52.4, 13.0475, '1945-07-17', 1, 'https://example.com/potsdam', 'https://example.com/images/potsdam.jpg'),
       (1, 'Кровавое воскресенье',
        ...
        59.9398, 30.3141, '1905-01-09', 2, 'https://example.com/bloody-sunday', 'https://example.com/bloody-sunday.jpg'),
       (1, 'Ходынская трагедия',
        'Массовая давка на Ходынском поле в Москве во время раздачи царских подарков на коронации Николая II.',
        55.7897, 37.5405, '1896-05-30', 1, 'https://example.com/khodynka', 'https://example.com/khodynka.jpg'),
       (1, 'Новочеркасский расстрел',
        ...
        47.4214, 40.0933, '1962-06-02', 3, 'https://example.com/novocherkassk', 'https://example.com/novocherkassk.jpg'),
       (1, 'Восстание декабристов',
        'Вооружённое восстание офицеров на Сенатской площади против самодержавия и крепостного права.',
        59.9341, 30.3063, '1825-12-26', 2, 'https://example.com/decembrists', 'https://example.com/decembrists.jpg'),
       (1, 'Соляной бунт', 'Народное восстание в Москве против повышения налога на соль и произвола бояр.',
        55.7558, 37.6173, '1648-06-01', 1, 'https://example.com/salt-riot', 'https://example.com/salt-riot.jpg'),
       (1, 'Медный бунт', 'Восстание в Москве из-за обесценивания медных денег и финансового кризиса.',
        55.7558, 37.6173, '1662-07-25', 4, 'https://example.com/copper-riot', 'https://example.com/copper-riot.jpg'),
       (1, 'Астраханское восстание', 'Народное восстание стрельцов и посадских людей против воеводы и приказных.',
        46.3497, 48.04, '1705-07-30', 4, 'https://example.com/astrakhan-uprising', 'https://example.com/astrakhan-uprising.jpg'),
       (1, 'Чумной бунт', 'Восстание в Москве против карантинных мер во время эпидемии чумы.',
        55.7558, 37.6173, '1771-09-15', 4, 'https://example.com/plague-riot', 'https://example.com/plague-riot.jpg'),
       (1, 'Кронштадтское восстание',
        ...
        60.008, 29.77, '1921-03-01', 4, 'https://example.com/kronstadt', 'https://example.com/kronstadt.jpg'),
       (1, 'Тамбовское восстание',
        'Крупнейшее крестьянское восстание против политики военного коммунизма и продразвёрстки.',
        52.7213, 41.4446, '1920-08-19', 1, 'https://example.com/tambov', 'https://example.com/tambov.jpg'),
       (1, 'Взятие Казани', 'Штурм и взятие Казани войсками Ивана Грозного, присоединение Казанского ханства к России.',
        55.7985, 49.1055, '1552-10-02', 2, 'https://example.com/kazan-siege', 'https://example.com/kazan-siege.jpg'),
       (1, 'Штурм Измаила', 'Взятие турецкой крепости Измаил войсками Суворова во время русско-турецкой войны.',
        45.3567, 28.84, '1790-12-22', 2, 'https://example.com/izmail', 'https://example.com/izmail.jpg'),
       (1, 'Оборона Севастополя',
        ...
        44.6178, 33.5244, '1854-10-13', 2, 'https://example.com/sevastopol-defense', 'https://example.com/sevastopol-defense.jpg'),
       (1, 'Блокада Ленинграда', 'Начало блокады Ленинграда немецкими войсками, длившейся 872 дня.',
        59.9398, 30.3141, '1941-09-08', 2, 'https://example.com/leningrad-blockade', 'https://example.com/leningrad-blockade.jpg'),
       (1, 'Штурм Берлина', 'Финальная операция Великой Отечественной войны, взятие Берлина советскими войсками.',
        52.52, 13.405, '1945-04-16', 2, 'https://example.com/berlin-assault', 'https://example.com/berlin-assault.jpg'),
       (1, 'Бой у озера Хасан', 'Вооруженный конфликт между СССР и Японией у озера Хасан на границе с Маньчжурией.',
        42.6833, 131.6, '1938-07-29', 3, 'https://example.com/khasan', 'https://example.com/khasan.jpg'),
       (1, 'Бои на Халхин-Голе', 'Военный конфликт между СССР и Японией на монгольско-маньчжурской границе.',
        47.7333, 118.25, '1939-05-11', 3, 'https://example.com/khalkhin-gol', 'https://example.com/khalkhin-gol.jpg'),
       (1, 'Даманский конфликт',
        'Пограничный вооруженный конфликт между СССР и КНР на острове Даманский на реке Уссури.',
        46.4833, 133.7833, '1969-03-02', 3, 'https://example.com/damansky', 'https://example.com/damansky.jpg'),
       (1, 'Инцидент у острова Жаланашколь',
        ...
        45.1167, 79.0833, '1969-08-13', 3, 'https://example.com/zhalanashkol', 'https://example.com/zhalanashkol.jpg'),
       (1, 'Бой у острова Даманский', 'Второе столкновение советских пограничников с китайскими военными на Даманском.',
        46.4833, 133.7833, '1969-03-15', 3, 'https://example.com/damansky-2', 'https://example.com/damansky-2.jpg');
