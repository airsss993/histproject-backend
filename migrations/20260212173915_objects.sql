...
(
    ...
    latitude          DOUBLE PRECISION NOT NULL CHECK (latitude >= -90 AND latitude <= 90),    -- Широта
    longitude         DOUBLE PRECISION NOT NULL CHECK (longitude >= -180 AND longitude <= 180), -- Долгота
...
CREATE INDEX ind_objects_latitude ON objects (latitude);
CREATE INDEX ind_objects_longitude ON objects (longitude);
